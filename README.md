This repo contains sailing downstream coding challenge task . task.js file contains the program which accepts the list of integers , emits an error if the list is not a
